  ...
  it('includes all 1.0 stable plugin registry entries', () => {
    const stableEntries = [
      ...
      },
      {
        kind: 'transform',
        type: 'image-cos',
        packageName: '@elog/plugin-image-cos',
        importName: 'imageCos',
      },
      {
        kind: 'transform',
        type: 'image-oss',
        packageName: '@elog/plugin-image-oss',
        importName: 'imageOss',
      },
      {
        kind: 'transform',
        type: 'image-github',
        packageName: '@elog/plugin-image-github',
        importName: 'imageGithub',
      },
      {
        kind: 'transform',
        type: 'image-qiniu',
        packageName: '@elog/plugin-image-qiniu',
        importName: 'imageQiniu',
      },
      {
        kind: 'transform',
        type: 'image-upyun',
        packageName: '@elog/plugin-image-upyun',
        importName: 'imageUpyun',
      },
      {
        kind: 'transform',
        type: 'image-r2',
        packageName: '@elog/plugin-image-r2',
        importName: 'imageR2',
      },
      {
        kind: 'transform',
        type: 'image-b2',
        packageName: '@elog/plugin-image-b2',
        importName: 'imageB2',
      },
      {
        kind: 'to',
