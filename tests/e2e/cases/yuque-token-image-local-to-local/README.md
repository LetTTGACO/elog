# Yuque Token Image Local To Local E2E Case

This case runs the real Elog CLI against a real Yuque repository using an API
token, downloads images to a local `images/` directory, and deploys markdown
files to `docs/`.
